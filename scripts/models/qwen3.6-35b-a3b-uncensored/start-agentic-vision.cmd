...
rem Model
set "MODEL_ARGS=--model "%LLM_ROOT%\models\qwen3.6-35b-a3b-uncensored\Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf""

rem Context and performance
set "PERFORMANCE_ARGS=--gpu-layers 999 --n-cpu-moe 28 --ctx-size 262144 --parallel 1 --cache-ram 0 --flash-attn on --split-mode none --fit off --threads 8 --threads-batch 8 --batch-size 1024 --ubatch-size 1024 --jinja"

rem Network and API identity
set "NETWORK_ARGS=--host 0.0.0.0 --port 8080 --alias qwen3.6-35b-a3b-uncensored"
...
rem Vision
set "VISION_ARGS=--mmproj "%LLM_ROOT%\models\qwen3.6-35b-a3b-uncensored\mmproj-Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive-f16.gguf" --image-min-tokens 1024"
