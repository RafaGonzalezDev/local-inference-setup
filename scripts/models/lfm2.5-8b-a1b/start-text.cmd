...
rem Model
set "MODEL_ARGS=--model "%LLM_ROOT%\models\lfm2.5-8b-a1b\LFM2.5-8B-A1B-Q8_0.gguf""

rem Context and performance
set "PERFORMANCE_ARGS=--gpu-layers 999 --ctx-size 128000 --parallel 1 --cache-ram 0 --flash-attn on --split-mode none --fit off --threads 8 --threads-batch 8 --batch-size 1024 --ubatch-size 512 --jinja"

rem Network and API identity
set "NETWORK_ARGS=--host 0.0.0.0 --port 8080 --alias lfm2.5-8b-a1b"

rem Reasoning
set "REASONING_ARGS=--reasoning on"

rem Sampling
set "SAMPLING_ARGS=--temp 0.2 --top-p 0.95 --top-k 80 --min-p 0 --presence-penalty 0 --repeat-penalty 1.05"
