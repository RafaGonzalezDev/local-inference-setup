...
set "PERFORMANCE_ARGS=--gpu-layers 999 --n-cpu-moe 16 --ctx-size 262144 --parallel 1 --cache-ram 0 --flash-attn on --split-mode none --fit off --threads 8 --threads-batch 8 --batch-size 1024 --ubatch-size 1024 --jinja"
