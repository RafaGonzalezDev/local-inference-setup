...
rem Conservative vision profile with a reduced initial context.
...
set "PERFORMANCE_ARGS=--gpu-layers 999 --ctx-size 32768 --parallel 1 --cache-ram 0 --flash-attn on --split-mode none --fit off --threads 8 --threads-batch 8 --batch-size 1024 --ubatch-size 512 --jinja"
...
rem Vision
set "VISION_ARGS=--mmproj "%LLM_ROOT%\models\qwen3.8-27b\mmproj-F16.gguf" --image-min-tokens 1024"
