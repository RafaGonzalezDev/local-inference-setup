...
rem Model
set "MODEL_ARGS=--model "%LLM_ROOT%\models\ornith-1.0-35b\Ornith-1.0-35B-UD-Q4_K_M.gguf""

rem Context and performance
set "PERFORMANCE_ARGS=--gpu-layers 999 --n-cpu-moe 25 --ctx-size 262144 --parallel 1 --cache-ram 0 --flash-attn on --split-mode none --fit off --threads 8 --threads-batch 8 --batch-size 1024 --ubatch-size 512 --jinja"

rem Network and API identity
set "NETWORK_ARGS=--host 0.0.0.0 --port 8080 --alias ornith-1.0-35b"
